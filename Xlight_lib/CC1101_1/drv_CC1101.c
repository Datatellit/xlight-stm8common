...
{
  CC1101_Set_Address( addr, BROAD_0AND255 );
...
bool CC1101_Check(void){
    ...
    partnum = CC1101_Read_Reg(CC1101_PARTNUM); //reads CC1100 partnumber
    version = CC1101_Read_Reg(CC1101_VERSION); //reads CC1100 version number
